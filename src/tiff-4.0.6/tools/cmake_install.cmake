# Install script for directory: /home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/bmp2tiff")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/bmp2tiff" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/bmp2tiff")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/bmp2tiff")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/fax2ps")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/fax2ps" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/fax2ps")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/fax2ps")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/fax2tiff")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/fax2tiff" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/fax2tiff")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/fax2tiff")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/gif2tiff")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/gif2tiff" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/gif2tiff")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/gif2tiff")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/pal2rgb")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/pal2rgb" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/pal2rgb")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/pal2rgb")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/ppm2tiff")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/ppm2tiff" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/ppm2tiff")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/ppm2tiff")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/ras2tiff")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/ras2tiff" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/ras2tiff")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/ras2tiff")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/raw2tiff")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/raw2tiff" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/raw2tiff")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/raw2tiff")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/rgb2ycbcr")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/rgb2ycbcr" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/rgb2ycbcr")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/rgb2ycbcr")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/thumbnail")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/thumbnail" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/thumbnail")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/thumbnail")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/tiff2bw")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/tiff2bw" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/tiff2bw")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/tiff2bw")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/tiff2pdf")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/tiff2pdf" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/tiff2pdf")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/tiff2pdf")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/tiff2ps")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/tiff2ps" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/tiff2ps")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/tiff2ps")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/tiff2rgba")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/tiff2rgba" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/tiff2rgba")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/tiff2rgba")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/tiffcmp")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/tiffcmp" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/tiffcmp")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/tiffcmp")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/tiffcp")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/tiffcp" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/tiffcp")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/tiffcp")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/tiffcrop")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/tiffcrop" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/tiffcrop")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/tiffcrop")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/tiffdither")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/tiffdither" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/tiffdither")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/tiffdither")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/tiffdump")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/tiffdump" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/tiffdump")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/tiffdump")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/tiffinfo")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/tiffinfo" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/tiffinfo")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/tiffinfo")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/tiffmedian")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/tiffmedian" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/tiffmedian")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/tiffmedian")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/tiffset")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/tiffset" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/tiffset")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/tiffset")
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/tiffsplit")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/tiffsplit" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/tiffsplit")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/tiffsplit")
...
if(NOT CMAKE_INSTALL_COMPONENT OR "${CMAKE_INSTALL_COMPONENT}" STREQUAL "Unspecified")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/tiffgt" AND
    ...
    file(RPATH_CHECK
         FILE "$ENV{DESTDIR}/usr/local/bin/tiffgt"
         RPATH "")
  endif()
  list(APPEND CMAKE_ABSOLUTE_DESTINATION_FILES
...
file(INSTALL DESTINATION "/usr/local/bin" TYPE EXECUTABLE FILES "/home/gbrunner/Documents/Programmation/SWWsimulator/src/tiff-4.0.6/tools/tiffgt")
  if(EXISTS "$ENV{DESTDIR}/usr/local/bin/tiffgt" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/usr/local/bin/tiffgt")
    file(RPATH_REMOVE
         FILE "$ENV{DESTDIR}/usr/local/bin/tiffgt")
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/usr/local/bin/tiffgt")
    endif()
  endif()
endif()
